...
/// </remarks>
public record GreaterThanOrEqualTo<TType, TContext>
    (IExpression<TType, TContext> Lhs, IExpression<TType, TContext> Rhs) : BinaryBoolComparison<TType, TContext>(Lhs,
        Rhs)
