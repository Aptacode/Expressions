...
namespace Aptacode.Expressions.Bool.RelationalOperators
{
...

    {
        ...
        {
            return obj is LessThanOrEqualTo<TType, TContext> expression && Equals(expression);
        }

        public override bool Equals(IExpression<bool, TContext> other)
        {
            return other is LessThanOrEqualTo<TType, TContext> expression && expression == this;
        }
