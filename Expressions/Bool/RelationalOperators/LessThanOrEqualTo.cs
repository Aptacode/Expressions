...
namespace Aptacode.Expressions.Bool.RelationalOperators
{
...

    {
        ...
        public override bool Equals(object obj) => obj is LessThanOrEqualTo<TType, TContext> expression && Equals(expression);

        public override bool Equals(IExpression<bool, TContext> other) => other is LessThanOrEqualTo<TType, TContext> expression && expression == this;

        public static bool operator ==(LessThanOrEqualTo<TType, TContext> lhs, LessThanOrEqualTo<TType, TContext> rhs)
        {
        ...
        public static bool operator !=(LessThanOrEqualTo<TType, TContext> lhs, LessThanOrEqualTo<TType, TContext> rhs) => !(lhs == rhs);
