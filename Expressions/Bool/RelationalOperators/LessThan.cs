...
namespace Aptacode.Expressions.Bool.RelationalOperators
{
...

    {
        ...
        public override bool Equals(object obj) => obj is LessThan<TType, TContext> expression && Equals(expression);

        public override bool Equals(IExpression<bool, TContext> other) => other is LessThan<TType, TContext> expression && expression == this;
        ...
        public static bool operator !=(LessThan<TType, TContext> lhs, LessThan<TType, TContext> rhs) => !(lhs == rhs);
