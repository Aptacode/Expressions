...
public class ExpressionFactory_Tests
{
    ...
    public void ListTest()
    {
        ...
        for (var i = 0; i < 20; i++)
        {
            fibListExpression = _expressions.List(_expressions.ConditionalList(
                _expressions.LessThan(_expressions.Last(fibListExpression), _expressions.Int(100)),
    ...
    public void ExpressionFactoryConditional_SuccessfullyCreates_ConditionalExpression_Test()
    {
        ...
        //Act
        var sut = _expressions.Conditional(_expressions.Bool(true), _expressions.Expression(_type),
            _expressions.Expression(_type));
        //Assert
